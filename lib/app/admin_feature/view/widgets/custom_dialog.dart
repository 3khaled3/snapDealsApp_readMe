...
static void editCategory(
  ...
  final cubit = BlocProvider.of<EditCategoryCubit>(context); // ✅ خذ نفس الCubit
              ...
              children: [
                Expanded(
                  child: CustomBottomSheet.buildButton(
                    ...
                    onTap: () => Navigator.pop(dialogContext), // استخدم dialogContext هنا
                  ),
                ),
...
static void deleteCategory(BuildContext context, String categoryId) {
  final cubit = BlocProvider.of<EditCategoryCubit>(context); // ✅ خد نفس الCubit

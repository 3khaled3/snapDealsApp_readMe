...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "CancelationPolicyDiscription3": MessageLookupByLibrary.simpleMessage(
      "*الإلغاء بعد الشحن:*",
    ),
    ...
    "CancelationPolicyDiscription5": MessageLookupByLibrary.simpleMessage(
      "*كيفية الإلغاء:*",
    ),
    ...
    "TermsAndConditionTitle1": MessageLookupByLibrary.simpleMessage(
      "*قبول الشروط*",
    ),
    "TermsAndConditionTitle2": MessageLookupByLibrary.simpleMessage(
      "*تسجيل الحساب*",
    ),
    "TermsAndConditionTitle3": MessageLookupByLibrary.simpleMessage(
      "*المنتجات والتوافر*",
    ),
    "TermsAndConditionTitle4": MessageLookupByLibrary.simpleMessage(
      "*الطلبات والدفع*",
    ),
    "TermsAndConditionTitle5": MessageLookupByLibrary.simpleMessage(
      "*الشحن والتوصيل*",
    ),
    ...
    "add_category_hint": MessageLookupByLibrary.simpleMessage("أدخل اسم الفئة"),
    ...
    "contactSupport": MessageLookupByLibrary.simpleMessage("الدردشة مع الدعم"),
    ...
    "copyTextError": MessageLookupByLibrary.simpleMessage(
      "حدث خطأ أثناء نسخ النص",
    ),
    ...
    "delete_account_error": MessageLookupByLibrary.simpleMessage(
      "حدث خطأ أثناء حذف الحساب",
    ),
    "delete_account_success": MessageLookupByLibrary.simpleMessage(
      "تم حذف الحساب بنجاح",
    ),
    "delete_all": MessageLookupByLibrary.simpleMessage("حذف جميع الإشعارات"),
    "delete_all_notifications": MessageLookupByLibrary.simpleMessage(
      "حذف جميع الإشعارات",
    ),
    ...
    "delete_product_error": MessageLookupByLibrary.simpleMessage(
      "حدث خطأ أثناء الحذف ",
    ),
    "delete_product_success": MessageLookupByLibrary.simpleMessage(
      "تم الحذف  بنجاح",
    ),
    ...
    "fontFamilyLora": MessageLookupByLibrary.simpleMessage("NotoKufiArabic"),
    ...
    "no_reviews": MessageLookupByLibrary.simpleMessage("لا توجد تقييمات بعد"),
    ...
    "otpScreenLabel": MessageLookupByLibrary.simpleMessage("أدخل رمز التحقق"),
    "ownerInformation": MessageLookupByLibrary.simpleMessage("تواصل مع المالك"),
    ...
    "review_success": MessageLookupByLibrary.simpleMessage(
      "تم إرسال التقييم بنجاح",
    ),
    "reviews": MessageLookupByLibrary.simpleMessage("التقييمات"),
    "saveButton": MessageLookupByLibrary.simpleMessage("حفظ"),
    "search": MessageLookupByLibrary.simpleMessage("بحث"),
    "search_user_error": MessageLookupByLibrary.simpleMessage(
      "لم يتم العثور على المستخدم",
    ),
    "search_user_label": MessageLookupByLibrary.simpleMessage(
      "أدخل معرف المستخدم",
    ),
    "search_user_success": MessageLookupByLibrary.simpleMessage(
